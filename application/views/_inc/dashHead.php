...
<head>
    ...
    <link href="<?= base_url('assets/dash/datatables/dataTables.bootstrap4.min.css')?>" rel="stylesheet">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=base_url()?>Dashboard">
                ...
                <div class="sidebar-brand-text mx-3">
                    <img alt="logo" src="<?=base_url('assets/images/logo.png')?>" width="100%" style="border-radius: 1.3rem;">
            ...
            <?php if($this->session->userdata('level') == 1 || $this->session->userdata('level') == 2): ?>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse item-menu" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form-- class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            <input type="text" class="form-control bg-ligh border-0 small" placeholder="Pesquisar..." aria-label="Search" aria-describedby="basic-addon2">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a style="background-color: #00204A;height: 40px;border-radius: 10px;" class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
