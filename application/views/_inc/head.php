...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="<?=base_url('assets/css/fontawesome-free-5.0.1/css/fontawesome-all.css')?>">
	<link rel="stylesheet" type="text/css" href="<?=base_url('assets/dash/vendor/fontawesome-free/css/all.min.css')?>">
   ...
   <link rel="stylesheet" type="text/css" href="<?=base_url('assets/css/sec_style.css')?>">
	...
	<link rel="stylesheet" type="text/css" href="<?=base_url('assets/css/bootstrap-dropdownhover.min.css')?>">
...
<div class="super_container" >
	...
	<header class="header d-flex flex-row">
		<div class="header_content d-flex flex-row align-items-center">
			...
			<div class="logo_container">
				<div class="logo">
					<!--img src="" alt="" width="40%" style="border-radius: 15rem 15rem 15rem 15rem; background-color:#fafbfc"-->
					<span>LOGO</span>
				</div>
			</div>
		...
		<div class="header_side d-flex flex-row justify-content-center align-items-center" >
			<span >
				...
				<li class="menu_social_item menu_mm"><a href="#"><i class="fab fa-youtube" style="color:#fff!important; font-size:20px"></i></a></li>
			</span>
		</div>
		<!-- Hamburger -->
   ...
   <div class="home"  >
		<!-- Hero Slider -->
		<div class="row" style='margin-top:4rem!important; height:70%'>
			<div class="col-lg-12">
