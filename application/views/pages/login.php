                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">FDL LOG</h1>
                                        <p class='text-center mt-1' style='color:red;'>
                                            <?php echo $this->session->flashdata('msg');?>
                                        </p>
                                    </div>
                                    <form class="user" method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>Auth/logUser">
                                        <div class="form-group">
                                            <input name="loginid" type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="ID do usuario...">
                                        </div>
                                        <div class="form-group">
                                            <input name="userPass" type="password" class="form-control form-control-user"
